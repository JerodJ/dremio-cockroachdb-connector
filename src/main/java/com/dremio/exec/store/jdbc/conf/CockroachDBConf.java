...
@SourceType(value = "CockroachDBARP", label = "CockroachDB",uiConfig = "cockroachdb-layout.json")
public class CockroachDBConf extends AbstractArpConf<CockroachDBConf> {
  ...
  private static final String DRIVER = "cdata.jdbc.cockroachdb.CockroachDBDriver";
